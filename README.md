...
pywisher is python scripts, which uses gmail to read records and send birthday wishes to all your friends, it's scheduled to run every day at ```00:01 IST``` using github actions.
